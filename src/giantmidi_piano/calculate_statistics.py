...
note_names = [
    r'$\mathregular{A_{0}}$',
    r'$\mathregular{A{\sharp}_{0}}$',
    r'$\mathregular{B_{0}}$',
    r'$\bf{C_{1}}$',
    r'$\mathregular{C{\sharp}_{1}}$',
    r'$\mathregular{D_{1}}$',
    r'$\mathregular{D{\sharp}_{1}}$',
    r'$\mathregular{E_{1}}$',
    r'$\mathregular{F_{1}}$',
    r'$\mathregular{F{\sharp}_{1}}$',
    r'$\mathregular{G_{1}}$',
    r'$\mathregular{G{\sharp}_{1}}$',
    r'$\mathregular{A_{1}}$',
    r'$\mathregular{A{\sharp}_{1}}$',
    r'$\mathregular{B_{1}}$',
    r'$\bf{C_{2}}$',
    r'$\mathregular{C{\sharp}_{2}}$',
    r'$\mathregular{D_{2}}$',
    r'$\mathregular{D{\sharp}_{2}}$',
    r'$\mathregular{E_{2}}$',
    r'$\mathregular{F_{2}}$',
    r'$\mathregular{F{\sharp}_{2}}$',
    r'$\mathregular{G_{2}}$',
    r'$\mathregular{G{\sharp}_{2}}$',
    r'$\mathregular{A_{2}}$',
    r'$\mathregular{A{\sharp}_{2}}$',
    r'$\mathregular{B_{2}}$',
    r'$\bf{C_{3}}$',
    r'$\mathregular{C{\sharp}_{3}}$',
    r'$\mathregular{D_{3}}$',
    r'$\mathregular{D{\sharp}_{3}}$',
    r'$\mathregular{E_{3}}$',
    r'$\mathregular{F_{3}}$',
    r'$\mathregular{F{\sharp}_{3}}$',
    r'$\mathregular{G_{3}}$',
    r'$\mathregular{G{\sharp}_{3}}$',
    r'$\mathregular{A_{3}}$',
    r'$\mathregular{A{\sharp}_{3}}$',
    r'$\mathregular{B_{3}}$',
    r'$\bf{C_{4}}$',
    r'$\mathregular{C{\sharp}_{4}}$',
    r'$\mathregular{D_{4}}$',
    r'$\mathregular{D{\sharp}_{4}}$',
    r'$\mathregular{E_{4}}$',
    r'$\mathregular{F_{4}}$',
    r'$\mathregular{F{\sharp}_{4}}$',
    r'$\mathregular{G_{4}}$',
    r'$\mathregular{G{\sharp}_{4}}$',
    r'$\mathregular{A_{4}}$',
    r'$\mathregular{A{\sharp}_{4}}$',
    r'$\mathregular{B_{4}}$',
    r'$\bf{C_{5}}$',
    r'$\mathregular{C{\sharp}_{5}}$',
    r'$\mathregular{D_{5}}$',
    r'$\mathregular{D{\sharp}_{5}}$',
    r'$\mathregular{E_{5}}$',
    r'$\mathregular{F_{5}}$',
    r'$\mathregular{F{\sharp}_{5}}$',
    r'$\mathregular{G_{5}}$',
    r'$\mathregular{G{\sharp}_{5}}$',
    r'$\mathregular{A_{5}}$',
    r'$\mathregular{A{\sharp}_{5}}$',
    r'$\mathregular{B_{5}}$',
    r'$\bf{C_{6}}$',
    r'$\mathregular{C{\sharp}_{6}}$',
    r'$\mathregular{D_{6}}$',
    r'$\mathregular{D{\sharp}_{6}}$',
    r'$\mathregular{E_{6}}$',
    r'$\mathregular{F_{6}}$',
    r'$\mathregular{F{\sharp}_{6}}$',
    r'$\mathregular{G_{6}}$',
    r'$\mathregular{G{\sharp}_{6}}$',
    r'$\mathregular{A_{6}}$',
    r'$\mathregular{A{\sharp}_{6}}$',
    r'$\mathregular{B_{6}}$',
    r'$\bf{C_{7}}$',
    r'$\mathregular{C{\sharp}_{7}}$',
    r'$\mathregular{D_{7}}$',
    r'$\mathregular{D{\sharp}_{7}}$',
    r'$\mathregular{E_{7}}$',
    r'$\mathregular{F_{7}}$',
    r'$\mathregular{F{\sharp}_{7}}$',
    r'$\mathregular{G_{7}}$',
    r'$\mathregular{G{\sharp}_{7}}$',
    r'$\mathregular{A_{7}}$',
    r'$\mathregular{A{\sharp}_{7}}$',
    r'$\mathregular{B_{7}}$',
    r'$\bf{C_{8}}$',
]
...
chroma_names = [
    r'$\bf{C}$',
    r'$\mathregular{C{\sharp}}$',
    r'$\mathregular{D}$',
    r'$\mathregular{D{\sharp}}$',
    r'$\mathregular{E}$',
    r'$\mathregular{F}$',
    r'$\mathregular{F{\sharp}}$',
    r'$\mathregular{G}$',
    r'$\mathregular{G{\sharp}}$',
    r'$\mathregular{A}$',
    r'$\mathregular{A{\sharp}}$',
    r'$\mathregular{B}$',
]
...
def meta_info(
    ...
    print(f'Music pieces num: {len(solo_piano_works_indexes)}')
    ...
    print(f'Composers num: {len(unique_solo_piano_composer_names)}')
...
def plot_composer_works_num(
    ...
    line1 = ax.bar(
        np.arange(top_composers),
        sorted_complete_works,
        align='center',
        color='pink',
        alpha=0.5,
    ...
    line2 = ax.bar(
        np.arange(top_composers),
        sorted_solo_piano_works,
        align='center',
        color='C0',
        alpha=1,
        label='Solo piano works',
    )
    ...
    ax.legend(handles=[line1, line2], fontsize=15, loc=1, framealpha=1.0)

    plt.tight_layout(pad=0, h_pad=0, w_pad=0)
    plt.savefig(fig_path)

    print(f'Save fig to {fig_path}')
...
def plot_composer_durations(
    ...
    line1 = ax.bar(
        np.arange(N), sorted_full_durations, align='center', color='pink', alpha=0.5, label='Complete works'
    )

    line2 = ax.bar(np.arange(N), sorted_piano_durations, align='center', color='C0', alpha=1, label='Solo piano works')

    for i, v in enumerate(sorted_piano_durations):
        round_v = int(np.around(v))
        ax.text(
            i - 0.3,
            max(v - len(str(round_v)) * 1.2, 0.5),
            str(round_v),
            color='yellow',
            fontweight='bold',
            rotation=90,
...
def plot_nationalities(
    ...
    nationality_color_bar = {
        'unknown': c_unknown,
        'German': c_europe,
        'French': c_europe,
        'American': c_north_america,
        'British': c_europe,
        'Italian': c_europe,
        'Russian': c_europe,
        'Austrian': c_europe,
        ...
        'Swedish': c_europe,
        'Hungarian': c_europe,
        'Brazilian': c_south_america,
        'Dutch': c_europe,
        'Danish': c_europe,
        'Australian': c_europe,
        'Canadian': c_north_america,
        'Ukrainian': c_europe,
        'Finnish': c_europe,
        'Mexican': c_south_america,
        'Swiss': c_europe,
        'Bohemian': c_europe,
        'Argentine': c_south_america,
        'Irish': c_europe,
        'Japanese': c_asia,
        'Portuguese': c_europe,
        'Armenian': c_europe,
        'Romanian': c_europe,
        'Chinese': c_asia,
        'Cuban': c_south_america,
        'Chilean': c_south_america,
        'Croatian': c_europe,
        'Venezuelan': c_south_america,
        'Filipino': c_asia,
        'Colombian': c_south_america,
        'Uruguayan': c_south_america,
        'Iranian': c_asia,
        'Azerbaijani': c_asia,
        'Bulgarian': c_europe,
        'Indian': c_asia,
        ...
        'Icelandic': c_europe,
        'Turkish': c_asia,
        'Paraguayan': c_south_america,
        'Egyptian': c_africa,
        'Lithuanian': c_europe,
        'Ecuadorean': c_south_america,
        'Latvian': c_europe,
        'Nigerian': c_africa,
        'Greek': c_europe,
...
def calculate_music_events_from_midi(
    ...
    for n, midi_name in enumerate(midi_names):
        ...
        target_processor = TargetProcessor(segment_seconds, frames_per_second, begin_note, classes_num)
    ...
    print(f'Dump to {all_music_events_path}')
...
def plot_note_histogram(
    ...
    ax.bar(np.arange(classes_num)[white_notes], counts[white_notes], align='center', color='k', fill=False, hatch='')

    ax.bar(np.arange(classes_num)[black_notes], counts[black_notes], align='center', color='k')
    ...
    if surname_in_youtube_title:
        ...
        ax.yaxis.set_ticklabels(['0', '200,000', '400,000', '600,000', '800,000', '1,000,000'], fontsize=10)
    else:
        ax.yaxis.set_ticks([0, 2e5, 4e5, 6e5, 8e5, 1e6, 1.2e6])
        ax.yaxis.set_ticklabels(
            ['0', '200,000', '400,000', '600,000', '800,000', '1,000,000', '1,200,000'], fontsize=10
        )
    ...
    print(f'Notes number: {counts}')
    print(f'Total notes: {np.sum(counts)}')
...
def plot_selected_composers_note_histogram(
    ...
    for j, composer in enumerate(composers):
        ...
        axs[j].bar(np.arange(classes_num)[white_notes], counts[white_notes], align='center', fill=False, hatch='')
        axs[j].bar(np.arange(classes_num)[black_notes], counts[black_notes], align='center', color='k')
...
def plot_mean_std_notes(
    ...
    # Load meta
    durations_dict = meta_info(workspace, surname_in_youtube_title)
    ...
    for i, v in enumerate(mean_array):
        ax.text(i - 0.3, min(v + 9, 53), f'{v + 21:.2f}', color='red', fontweight='bold', rotation=90)
...
def plot_notes_per_second_mean_std(
    ...
    for i, v in enumerate(mean_array):
        ax.text(i - 0.3, v + 3.5, f'{v:.2f}', color='red', fontweight='bold', rotation=90)
...
def plot_selected_composers_chroma(
    ...
    for j, composer in enumerate(six_composers):
        ...
        axs[j // 3, j % 3].bar(
            white_notes_octave, chroma_frequency[white_notes_octave], align='center', color='k', fill=False, hatch=''
        )
        axs[j // 3, j % 3].bar(black_notes_octave, chroma_frequency[black_notes_octave], align='center', color='k')
...
def plot_selected_composers_intervals(
    ...
    for j, composer in enumerate(six_composers):
        ...
        axs[j // 3, j % 3].bar(
            white_notes_inverval,
            interval_frequency[white_notes_inverval],
            align='center',
            color='k',
            fill=False,
            hatch='',
        ...
        axs[j // 3, j % 3].bar(
            black_notes_inverval, interval_frequency[black_notes_inverval], align='center', color='k'
        )
...
def plot_selected_composers_chords(
    ...
    all_music_events_path = os.path.join(workspace, 'all_music_events.pkl')
    meta_path = os.path.join(workspace, 'statistics.pkl')
    fig_path = f'results/selected_composers_chords_{n_chords}.pdf'
    os.makedirs(os.path.dirname(fig_path), exist_ok=True)
